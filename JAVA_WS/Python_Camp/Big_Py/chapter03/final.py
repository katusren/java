...
# headless 모드 설정(브라우저 창이 띄워지지 않음 => 백그라운드에서 작업)
chrome_option.add_argument("--headless")
# 사운드 설정
chrome_option.add_argument("--mute-audio")

# headeless 모드 적용
# browser=webdriver.Chrome(option=chrome_option, executable_path=r'C:/chromedriver/chromedriver.exe')
...
# 엑셀 파일 생성
workbook = xlsxwriter.Workbook('C:/Users/soldesk/Downloads/JAVA/data/you_crawl_result.xlsx')
